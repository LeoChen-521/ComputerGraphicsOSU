...
const char *WINDOWTITLE = { "OpenGL / Project 4 -- Xiaoru Chen" };
...
// Global variables for project 4
GLuint  Tex0, Tex1;
GLuint  SphereList1;
GLuint  SphereList2;
GLuint  SphereList3;
...
//-------------------------------------------------------------------------------------
	...
	SetPointLight( GL_LIGHT0, 16., 8., 20., 		1., 1., 1.);
	//glDisable(GL_LIGHTING);
	glPopMatrix();

//-------------------------------------------------------------------------------------
	// light 1 is Yellow = Red + Green		key 1, it is moving
	glPushMatrix();
	// glTranslatef(0.,0.,9.);
	...
	//OsuSphere(0.5, 30., 30.);
	glutSolidSphere(0.25, 100, 100);
	//glCallList(SphereList3);
	SetPointLight( GL_LIGHT1, 0., 0., 9., 		1., 1., 0.);
	glPopMatrix();

//-------------------------------------------------------------------------------------
	// light 2 is green 						key 2

	//SetPointLight( GL_LIGHT2, 0., 3., 3., 		0, 0, 1);
	glPushMatrix();
	glTranslatef(-1.,2., 5.);
	glColor3f(0.,1.,0.);
	//SetMaterial(0., 0., 1., 5.);
	glutSolidSphere(0.25, 100, 100);
	//OsuSphere(0.5, 30., 30.);
	SetSPOTLight ( GL_LIGHT2, -1., 2., 10.,      1., 0.5, -1.,      0., 1., 0.);
	glPopMatrix();
	...
	//SetPointLight(GL_LIGHT0, 20., 20., 20., )
...
InitLists( )
{
	...
	SphereList1 = glGenLists (1);
	glNewList(SphereList1, GL_COMPILE);
	...
	SphereList3 = glGenLists (1);
	glNewList(SphereList3, GL_COMPILE);
	...
	// Create the display list for the cylinder-----------------------------------
...
MyCylinder()
{
	...
	glBegin (GL_POLYGON);
		...
		{
			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang1), 0., 2.5*sin(ang1));
			
			glVertex3f (2.5*cos(ang1), 0., 2.5*sin(ang1));
			ang1 += dang1;
		}
	...
	glBegin (GL_POLYGON);
		...
		{ 
			//glColor3f( 1., 0., 0. );
			glNormal3f(2.5*cos(ang2), 3., 2.5*sin(ang2));
			//glColor3f( 0., 0., 1. );
			glVertex3f (2.5*cos(ang2), 3., 2.5*sin(ang2));
			ang2 += dang2;
		}
	glEnd();


	// First 1/4 surface color : RED
	// glColor3f( 1., 0., 0. );
	float dang3 = 2. *M_PI/(float)(60);
	float ang3 = 0.;
	//glColor3f( 1., 0., 0. );
	glBegin (GL_QUADS);
		//glColor3f(1., 0., 0.);
		for (int i = 0; i<15; i++)
		{ 
			glNormal3f (2.5*cos(ang3), 3., 2.5*sin(ang3));
			glVertex3f (2.5*cos(ang3), 3., 2.5*sin(ang3));

			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang3), 0., 2.5*sin(ang3));
			glVertex3f (2.5*cos(ang3), 0., 2.5*sin(ang3));
	...
	// Second 1/4 surface color : Magenta = RED + BLUE
	// glColor3f( 1., 0., 1. );
	float dang4 = 2. *M_PI/(float)(60);
	float ang4 = ang3;
	...
	glBegin (GL_QUADS);
		...
		{ 
			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang4), 3., 2.5*sin(ang4));
			glVertex3f (2.5*cos(ang4), 3., 2.5*sin(ang4));

		//	glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang4), 0., 2.5*sin(ang4));
			glVertex3f (2.5*cos(ang4), 0., 2.5*sin(ang4));
	...
	// Third 1/4 surface color : Yellow = RED + GREEN
	//glColor3f( 1., 1., 0. );
	float dang5 = 2. *M_PI/(float)(60);
	float ang5 = ang4;
	//glColor3f( 1., 0., 0. );
	glBegin (GL_QUADS);
		glColor3f(1., 0., 0.);
		...
		{
			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang5), 3., 2.5*sin(ang5));
			glVertex3f (2.5*cos(ang5), 3., 2.5*sin(ang5));

			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang5), 0., 2.5*sin(ang5));
			glVertex3f (2.5*cos(ang5), 0., 2.5*sin(ang5));
	...
	// Forth 1/4 surface color : White = RED + GREEN + BLUE
	// glColor3f( 1., 1., 1. );
	float dang6 = 2. *M_PI/(float)(60);
	float ang6 = ang5;
	//glColor3f( 1., 0., 0. );
	glBegin (GL_QUADS);
		glColor3f(1., 0., 0.);
		...
		{
			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang6), 3., 2.5*sin(ang6));
			glVertex3f (2.5*cos(ang6), 3., 2.5*sin(ang6));

			//glColor3f( 1., 0., 0. );
			glNormal3f (2.5*cos(ang6), 0., 2.5*sin(ang6));
			glVertex3f (2.5*cos(ang6), 0., 2.5*sin(ang6));
